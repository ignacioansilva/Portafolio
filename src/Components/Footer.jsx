import footerGraffiti from "../imagenes/FooterGraf.jpg"
    ...
    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        ...
        <ul class="flex gap-6 mt-8">
          <li>
            <a
              href="https://www.facebook.com/ignacio.silva.790693/"
              rel="noreferrer"
              target="_blank"
          ...
          <li>
            <a
              href="https://github.com/ignacioansilva?tab=repositories"
              rel="noreferrer"
              target="_blank"
              class="text-gray-700 transition hover:opacity-75"
            >
